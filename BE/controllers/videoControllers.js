...
exports.getStream = asyncHandler(async (req, res) => {
  ...
  if (!plan) {
    ...
    //res.status(400).json({
    //        error: 'You re not subscribed to any plans'
    //  })
  }
  //console.log("aneeshhello")
  ...
  switch (quality) {
    case 'high':
      //console.log(plan.max_quality, resHigh)
      ...
      break
    case 'med':
      //console.log(plan.max_quality, resMed)
      ...
      break
    case 'low':
      console.log(plan.max_quality, resLow)
      if (plan.max_quality < resLow) {
        res.status(403)
        throw new Error("Your plan doesn't support this resolution")
      }
      try {
        //console.log(sizeLow, type)
        //console.log(streamLow)
...
exports.getAllVideos = asyncHandler(async (req, res) => {
  let q = req.query
  //console.log(req)
  //console.log(process.env.GET_VIDEO_LIMIT)
  //console.log(JSON.parse(process.env.GET_VIDEO_LIMIT))
...
exports.createVideo = asyncHandler(async (req, res, next) => {
  ...
  upload(req, res, (err) => {
    console.log(process.env.MAX_VIDEO_SIZE)
    //console.log(err)
...
const processVideo = (files, videoDataFromDB) => {
  ...
  //console.log(videoDestinationHigh)
